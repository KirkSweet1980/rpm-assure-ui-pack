...
| Task | When | Script |
|------|------|--------|
| RPMAssure-All-Api-Collect | every 15 min | Pulseway + Cove + Bitdefender (`-SkipCsp`) |
| RPMAssure-Csp-GraphCollect | every **60 min** | Microsoft 365 Graph (all `Csp.Config*.ps1`) |
