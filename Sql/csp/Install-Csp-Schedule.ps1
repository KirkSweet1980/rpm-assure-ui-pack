...
# Default: every 60 minutes. Requires Csp.Config*.ps1. Run as Administrator.
# Pure ASCII. No else.
param(
  [int]$Minutes = 60,
  [switch]$RunNow
...
Write-Host ("Creating scheduled task " + $taskName + " every " + $Minutes + " minutes") -ForegroundColor Cyan
...
Write-Host ("Scheduled: " + $taskName + " every " + $Minutes + " minutes") -ForegroundColor Green
try {
