    ...
    cove: {
      ...
      summary: {
        ...
        recovery: {
          ...
          lastImportAt: NOW,
          asOfDate: TODAY,
          lastRecoveryTestAt: NOW,
        },
      },
      devices: [
        {
          accountId: 101,
          deviceName: "ahic-prodev-srv_ncevd",
          machineName: "AHIC-PRODEV-SRV",
          ...
          importedAt: NOW,
          recoveryPlanType: 1,
          recoveryPlanLabel: "Recovery Testing (Biweekly)",
          recoveryTestStatus: "Success",
          recoveryStatus: "Completed",
          recoveryErrors: 0,
          recoveryColorBar:
            "NotStarted,Completed,Completed,Completed,Completed,Completed,Completed,Completed,Completed,Completed,Completed,Completed,Completed,Completed",
          lastCompletedSessionAt: NOW,
          lastRecoveryTestAt: NOW,
          backupSessionAt: NOW,
          recoveryDurationSec: 1524,
          recoveryDurationLabel: "25m 24s",
          bootStatus: "Success",
          screenshotPresented: false,
        },
        {
          accountId: 102,
          deviceName: "ahic-ssql-srv_nn9t7",
          machineName: "AHIC-SSQL-SRV",
          partnerName: "AHI Carriers",
          partnerId: 2602886,
          ...
          lastRecoveryTestAt: NOW,
          backupSessionAt: NOW,
          recoveryDurationSec: 2718,
          recoveryDurationLabel: "45m 18s",
          bootStatus: "Success",
          screenshotPresented: false,
        },
        {
          accountId: 103,
          deviceName: "ahic-syspro-app_ywhf4",
          machineName: "AHIC-SYSPRO-APP",
          partnerName: "AHI Carriers",
          partnerId: 2602886,
          usedBytes: 9000000000,
          lastSuccessTime: NOW,
          lastBackupStatus: "OK",
          snapshotDate: TODAY,
          importedAt: NOW,
          ...
          lastRecoveryTestAt: NOW,
          backupSessionAt: NOW,
          recoveryDurationSec: 3235,
          recoveryDurationLabel: "53m 55s",
          bootStatus: "Success",
          screenshotPresented: false,
        },
        {
