export type FontPackId = "inter" | "plex" | "source" | "jakarta" | "nunito";
...
export const FONT_PACKS: FontPack[] = [
  {
    id: "inter",
    name: "Inter",
    blurb: "DashboardKit default. Neutral, tight, built for admin UI.",
  ...
  },
  {
    id: "source",
    name: "Source Sans 3",
    blurb: "Adobe UI. Very readable at 14px, good for long tables.",
