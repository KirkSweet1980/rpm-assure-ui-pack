...
export const UI_LABEL_FIELDS: {
  ...
  { key: "tickets", label: "RPM Service Desk", help: "Service desk module name.", group: "Customer Services" },
  { key: "ticketsShort", label: "RPM Service Desk (Short)", help: "Compact service label.", group: "Customer Services" },
