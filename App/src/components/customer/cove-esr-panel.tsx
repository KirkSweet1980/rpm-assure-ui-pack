    ...
    <div className="space-y-4">
      <header>
        <p className="text-[20px] font-semibold tracking-tight text-fg">
          Hello {esr.customerName}, here’s your
        </p>
        <p className="text-[16px] font-medium text-sky-700 dark:text-sky-300">Executive summary report.</p>
        <p className="text-[12px] text-muted">Date range: {esr.periodLabel}</p>
      </header>
