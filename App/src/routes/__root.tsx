...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@500;600&family=IBM+Plex+Sans:wght@400;500;600;700&family=Inter:wght@400;500;600;700&family=Nunito+Sans:wght@400;600;700;800&family=Plus+Jakarta+Sans:wght@400;500;600;700&family=Source+Code+Pro:wght@500;600&family=Source+Sans+3:wght@400;600;700&display=swap",
      },
    ],
    scripts: [
      {
