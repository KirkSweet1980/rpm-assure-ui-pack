...
import { CspGlobalAdminsSection } from "@/components/customer/customer-sections";
import { Route as PillarRoute } from "./customers.$code.csp";

export const Route = createFileRoute("/customers/$code/csp/global-admins")({
  component: function CustomerChild() {
    ...
    return <CspGlobalAdminsSection data={data} />;
  },
});
