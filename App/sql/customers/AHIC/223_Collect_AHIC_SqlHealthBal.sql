...
DECLARE c CURSOR LOCAL FAST_FORWARD FOR
  ...
  WHERE state_desc = N'ONLINE'
    AND (name LIKE N'AHICAR_%' OR name LIKE N'SysproCompany%')
    AND name NOT LIKE N'%_SRS'
    AND name NOT IN (N'SYSPRODeployment', N'Sysprodb');
OPEN c;
...
PRINT N'=== Done AHIC SqlHealthBal ===';
GO
