...
sqlcmd -S "102.222.21.220,14333" -d "RPMAssure_App" -U "rpmassure" -P "" -C -Q "SELECT SUSER_SNAME() Who, DB_NAME() Db; SELECT TOP 3 CustomerCode, Active FROM Dim_Customer ORDER BY 1;"
...
sqlcmd -S "." -U "rpmassure" -P "" -C -Q "SELECT TOP 3 CustomerCode FROM [RPM_CENTRAL].[RPMAssure_App].dbo.Dim_Customer;"
