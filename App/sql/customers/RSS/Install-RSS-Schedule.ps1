# RSS — install 15-min + nightly via base direct collect
# Run as Administrator on RSS-PROD
...
& $base -ConfigPath $cfg -TaskPrefix 'RPMAssure' -IntervalMinutes 15 -NightlyTime '02:45'
