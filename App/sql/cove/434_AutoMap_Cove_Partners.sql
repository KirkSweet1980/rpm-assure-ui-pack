...
;WITH a AS (
  SELECT * FROM (VALUES
    ...
    (N'BHF', N'BHF', NULL, N'seed'),
    (N'BHF (PNCS)', N'BHF', 2925801, N'seed'),
    (N'Board of Healthcare Funders', N'BHF', NULL, N'seed alias'),
    (N'PCNS', N'BHF', 2925801, N'seed alias'),
    (N'Remote Site Solutions (Pty) Ltd', N'RSS', 2602886, N'seed'),
    (N'Remote Site Solutions', N'RSS', 2602886, N'seed alias'),
