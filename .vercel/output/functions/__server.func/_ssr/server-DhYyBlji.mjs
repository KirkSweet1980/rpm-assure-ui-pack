import { $t as runWithTransaction, B as string, C as runWithEndpointContext, D as toResponse, E as serializeSignedCookie, F as looseObject, Gt as ATTR_HOOK_TYPE, I as number, J as jwtVerify, Jt as safeJSONParse, K as decodeJwt, Kt as ATTR_OPERATION_ID, L as object, M as array, N as boolean, O as filterOutputFields, P as email, Qt as runWithAdapter, R as optional, S as getCurrentAuthContext, T as serializeCookie, Ut as withSpan, W as base64Url, Wt as ATTR_CONTEXT, Xt as getCurrentAdapter, Yt as getAuthTables, Zt as queueAfterTransactionHook, _ as createAuthMiddleware, _n as isDevelopment, _t as encode, a as betterFetch, an as APIError, b as hasRequestState, c as applyDefaultAccessTokenExpiry, cn as BASE_ERROR_CODES, d as findInvalidTrustedProxies, dn as logger, en as getBetterAuthVersion, f as getIp, fn as shouldPublishLog, g as createAuthEndpoint, h as normalizePathname, i as refreshAccessToken, in as createRandomStringGenerator, j as any, kt as JWTExpired, l as isLoopbackHost, mn as env, n as socialProviders, nn as initGetFieldName, on as BetterAuthError, p as deprecate, q as decodeProtectedHeader, qt as import_src, r as validateAuthorizationCode, rn as generateId, s as createAuthorizationURL, sn as kAPIErrorHeaderSymbol, t as SocialProviderListEnum, tn as initGetModelName, u as createRateLimitKey, un as createLogger, v as isAPIError, vn as isProduction, w as createRouter$1, x as runWithRequestState, y as defineRequestState, yn as isTest, z as record } from "../_libs/@better-auth/core+[...].mjs";
import { a as getHost, c as isDynamicBaseURLConfig, d as wildcardMatch, i as getBaseURL, l as isRequestLike, n as PACKAGE_VERSION, o as getOrigin, r as TWO_FACTOR_ERROR_CODES, s as getProtocol, t as GENERIC_OAUTH_ERROR_CODES, u as resolveBaseURL } from "./error-codes-BxM-hwON.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/server-DhYyBlji.js
...
var send2FaOTPBodySchema = object({ 
/**
* if true, the device will be trusted
* for 30 days. It'll be refreshed on
* every sign in request within this time.
*/
trustDevice: boolean().optional().meta({ description: "If true, the device will be trusted for 30 days. It'll be refreshed on every sign in request within this time. Eg: true" }) }).optional();
/**
...
async function createPgliteSql() {
	...
	const migrate = async () => {
		const migrations = /* #__PURE__ */ Object.assign({
			...
			"/migrations/0002_two_factor.sql": _0002_two_factor_default
		});
...
var envTrusted = (env$1("BETTER_AUTH_TRUSTED_ORIGINS") ?? "").split(",").map((s) => s.trim()).filter(Boolean);
var trustedOrigins = Array.from(/* @__PURE__ */ new Set([
	...explicitBaseURL ? [explicitBaseURL] : [],
	...envTrusted,
	...LOCAL_DEV_ORIGINS,
	"https://assure.rpmresources.co.za",
	"http://assure.rpmresources.co.za",
	...!explicitBaseURL ? [...previewAllowedHosts, ...previewAllowedHosts.flatMap((host) => [`https://${host}`, `http://${host}`])] : []
]));
...
var httpsMode = Boolean(explicitBaseURL?.startsWith("https://")) || env$1("RPM_ASSURE_HTTPS") === "1" || env$1("RPM_ASSURE_HTTPS") === "true";
/** Session token cookie name — also read by the live-preview popup completion page. */
var SESSION_TOKEN_COOKIE = httpsMode ? "__Host-grok-auth.session_token" : "grok-auth.session_token";
var SESSION_DATA_COOKIE = httpsMode ? "__Host-grok-auth.session_data" : "grok-auth.session_data";
var ACCOUNT_DATA_COOKIE = httpsMode ? "__Host-grok-auth.account_data" : "grok-auth.account_data";
var DONT_REMEMBER_COOKIE = httpsMode ? "__Host-grok-auth.dont_remember" : "grok-auth.dont_remember";
	...
	databaseHooks: { user: { create: {
		...
		async after(user) {
			...
			try {
				...
				if (!pool) return;
				const displayName = String(user.name || email.split("@")[0] || "User").slice(0, 200);
              ...
              `);
				...
				console.warn("[auth] App_User provision on sign-up failed:", e instanceof Error ? e.message : e);
			}
		}
	} } },
	advanced: {
