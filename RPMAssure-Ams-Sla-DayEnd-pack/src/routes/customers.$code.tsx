...
import { ServicesOnCoverStrip } from "@/components/customer/services-on-cover";
      ...
      <AppShell title={customer.displayName} subtitle={pageTitle}>
        ...
        <div className="rpma-d3-workspace">
          ...
          <div className="rpma-d3-detail min-w-0">
            ...
            <div className="rpma-customer-workspace space-y-2.5">
              <ServicesOnCoverStrip cover={data.cover ?? customer.cover} />
              <div className="rpma-workspace-sticky">
