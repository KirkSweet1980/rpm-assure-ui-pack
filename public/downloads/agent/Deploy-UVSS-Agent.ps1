# Deploy-UVSS-Agent.ps1
# Unique Ventilation Systems. No wizard. Administrator on that customer host.
#
#   powershell -NoProfile -ExecutionPolicy Bypass -File .\Deploy-UVSS-Agent.ps1 -AgentSecret '<IOPS secret>'
#
param(
