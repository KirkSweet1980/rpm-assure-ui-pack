        ...
        <CardContent className="space-y-4 p-4">
          {(
            ...
            >
              ...
              <div className="hmd-mods">
                {pillar.modules.map((m) =>
                  pillar.covered ? (
                    <SpaLink key={m.href} href={m.href} className="hmd-mlink">
                      {m.label}
                    </SpaLink>
                  ) : (
                    <span
                      key={m.href}
                      className="hmd-mlink is-off"
...
export function SysproHubSection({ data }: { data: CustomerDetailPayload }) {
  ...
  return (
    <ModuleList title="SYSPRO modules">
...
export function AmsHubSection({ data }: { data: CustomerDetailPayload }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <ModuleList title="Assure modules">
