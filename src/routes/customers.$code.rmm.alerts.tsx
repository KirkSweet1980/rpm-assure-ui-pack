...
import { RmmAlertsSection } from "@/components/customer/customer-sections";
import { Route as PillarRoute } from "./customers.$code.rmm";

export const Route = createFileRoute("/customers/$code/rmm/alerts")({
  ...
  return <RmmAlertsSection data={data} />;
},
});
