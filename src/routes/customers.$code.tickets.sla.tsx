...
import { TicketsSlaSection } from "@/components/customer/tickets-sections";
import { Route as PillarRoute } from "./customers.$code.tickets";

export const Route = createFileRoute("/customers/$code/tickets/sla")({
  component: function CustomerChild() {
    ...
    return <TicketsSlaSection data={data} />;
  },
});
