...
/** On the Assure box, never hairpin SQL via the public NIC. */
function localizeSqlHost(host: string): string {
  const h = host.trim().toLowerCase();
  if (h === "102.222.21.220") return "127.0.0.1";
  return host;
}
