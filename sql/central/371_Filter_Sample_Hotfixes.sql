/*
  CENTRAL 371b - exclude Sample hotfixes + rebuild gap views
  (no nested EXEC string quoting)
  sqlcmd -S "102.222.21.220,14333" -d RPMAssure_App -E -C -b -i 371_Filter_Sample_Hotfixes.sql
*/
USE RPMAssure_App;
GO
SET NOCOUNT ON;
...
/*
  Views below are VERSION-SCOPED (same as 372).
  Higher ReleaseLabel than customer ProductVersion is excluded.
*/
