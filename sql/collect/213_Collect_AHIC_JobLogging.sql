/*
  AHIC job logging → central Syspro_JobLogging
  ON AHIC-SSQL-SRV:

  sqlcmd -S "." -U "Rpm_collect" -P "RpmCollect#AHIC2026" -C -b -i "C:\RPM-Assure\Sql\collect\213_Collect_AHIC_JobLogging.sql"
...
PRINT CONCAT(N'=== AHIC job logging ', CONVERT(char(10), @SnapshotDate, 23), N' ===');
