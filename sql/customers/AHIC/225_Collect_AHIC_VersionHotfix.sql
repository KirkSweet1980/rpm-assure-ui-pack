/*
  AHIC — SYSPRO version + modules/hotfixes
  Dynamic columns only (AdmSystemLicense varies by release).
  Run ON customer SQL as Rpm_collect (linked server RPM_CENTRAL).
*/
SET NOCOUNT ON;
SET XACT_ABORT OFF;
SET ANSI_NULLS ON;
...
PRINT CONCAT(N'=== AHIC Version/Hotfix ', CONVERT(char(10), @SnapshotDate, 23), N' ===');
...
PRINT N'=== Done AHIC Version/Hotfix ===';
GO
