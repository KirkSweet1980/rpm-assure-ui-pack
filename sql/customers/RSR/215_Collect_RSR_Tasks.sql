...
PRINT 'Tasks: optional - skip if no tables';
IF OBJECT_ID(N'SysproDB.dbo.AdmTaskGroup',N'U') IS NULL AND OBJECT_ID(N'Sysprodb.dbo.AdmTaskGroup',N'U') IS NULL
  PRINT 'No AdmTaskGroup';
ELSE
  PRINT 'AdmTaskGroup present - collect can be expanded';

PRINT '=== Done 215 Tasks ===';
