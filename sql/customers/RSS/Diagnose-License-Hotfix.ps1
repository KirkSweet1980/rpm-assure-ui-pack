# Run ON RSS-PROD as Administrator / collect account
...
Initialize-RpmaCollect -LogDir $LogDir -Prefix 'rss_lic_diag'

Write-RpmaLog "=== RSS license/version/hotfix diagnose ==="
