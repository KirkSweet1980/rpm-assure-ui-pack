/*
  RSS — AdmSystemLicense → RPMAssure_App.Syspro_SystemLicense
  ON RSS-PROD:

  sqlcmd -S "." -U rpmassure -P "RpmCollect#AHIC2026" -C -b -i thisfile.sql
...
PRINT CONCAT(N'=== RSS SystemLicense ', CONVERT(char(10), @SnapshotDate, 23), N' ===');
...
PRINT N'=== Done RSS SystemLicense ===';
GO
