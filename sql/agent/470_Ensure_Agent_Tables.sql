...
BEGIN TRY
  ...
  GRANT SELECT ON dbo.Agent_Registry TO [rpmassure];
  GRANT SELECT ON dbo.Agent_JobRun TO [rpmassure];
  PRINT 'Granted rpmassure';
END TRY BEGIN CATCH PRINT 'Grant rpmassure soft-fail: ' + ERROR_MESSAGE(); END CATCH
GO
