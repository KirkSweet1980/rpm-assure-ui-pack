...
//#region node_modules/js-md4/src/md4.js
	...
	(function() {
		...
		*/
		...
		var nodeWrap = function(method) {
			...
			var nodeMethod = function(message) {
				if (typeof message === "string") return crypto.createHash("md4").update(message, "utf8").digest("hex");
				else if (ARRAY_BUFFER && message instanceof ArrayBuffer) message = new Uint8Array(message);
				else if (message.length === void 0) return method(message);
		...
		*/
		Md4.prototype.update = function(message) {
			...
			if (notString && ARRAY_BUFFER && message instanceof ArrayBuffer) message = new Uint8Array(message);
			...
			while (index < length) {
				...
				if (notString) if (ARRAY_BUFFER) for (i = this.start; index < length && i < 64; ++index) buffer8[i++] = message[index];
				else for (i = this.start; index < length && i < 64; ++index) blocks[i >> 2] |= message[index] << SHIFT[i++ & 3];
				else if (ARRAY_BUFFER) for (i = this.start; index < length && i < 64; ++index) {
